...
const Header = () => {
  ...
  return <header className="bg-[#ee4d2d] text-white text-[13px] pb-4">
    <div className="container mx-auto px-4">
      <button onClick={handleClickNavigateToCart}>Cart</button>
      {/* --- Top Navbar --- */}
      <div className="flex justify-between py-2">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex gap-3 font-semibold">
            <NavLink to="/register" className="hover:opacity-80">Đăng Ký</NavLink>
            <span className="opacity-30">|</span>
            <NavLink to="/logn" className="hover:opacity-80">Đăng Nhập</NavLink>
          </div>
        </div>
      </div>
