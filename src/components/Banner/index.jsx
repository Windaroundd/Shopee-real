...
const index = () => {
  return <div className="bg-[#f5f5f5] py-4">
        ...
        <div className="grid grid-cols-12 gap-1 mb-6">
          ...
          <div className="col-span-8 relative">
            ...
            <div className="absolute bottom-3 left-1/2 -translate-x-1/2 flex gap-2">
              <div className="w-2.5 h-2.5 bg-orange-600 rounded-full border border-white"></div>
              {[1, 2, 3, 4].map((i) => (
                <div key={i} className="w-2.5 h-2.5 bg-white/50 rounded-full border border-white/20"></div>
              ))}
            </div>
          </div>
  ...
  <div className="flex flex-col items-center gap-3 w-28 cursor-pointer group">
    ...
    <span className="text-[12px] font-medium text-gray-800 group-hover:text-[#ee4d2d]">Deal Từ 1.000Đ</span>
  </div>
  ...
  <div className="flex flex-col items-center gap-3 w-28 cursor-pointer group">
    ...
    <span className="text-[12px] font-medium text-gray-800 group-hover:text-[#ee4d2d]">Shopee Xử Lý</span>
  </div>
  ...
  <div className="flex flex-col items-center gap-3 w-28 cursor-pointer group">
    ...
    <span className="text-[12px] font-medium text-gray-800 group-hover:text-[#ee4d2d]">Giờ Vàng</span>
  </div>
  ...
  <div className="flex flex-col items-center gap-3 w-28 cursor-pointer group">
    ...
    <span className="text-[12px] font-medium text-gray-800 group-hover:text-[#ee4d2d]">Voucher 30%</span>
  </div>
  ...
  <div className="flex flex-col items-center gap-3 w-28 cursor-pointer group">
    ...
    <span className="text-[12px] font-medium text-gray-800 group-hover:text-[#ee4d2d]">Thành Viên</span>
  </div>
